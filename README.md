<h2>Hi there, I'm Yahel! 👋</h2>

<p>
    I am Software Developer</strong> and an M.Sc. student in Media & Human-Centered Computing at TU Wien. My background is a mix of Computer Science and Cognitive Science, which drives my passion for Human-Computer Interaction (HCI).
</p>
<p>
    My focus is crafting complete, end-to-end experiences that seamlessly connect physical user behavior with digital system logic. To actually build and test these concepts, I utilize Google Gemini as my daily coding assistant. Whether I am prototyping custom web tools or engineering interactive hardware, collaborating with an AI assistant allows me to rapidly program functional prototypes, learn new technologies on the fly, and turn complex ideas into working reality.
</p>

### 💻 Technologies & Tools
- **Languages:** Python, JavaScript, HTML/CSS, C/C++, Java, SQL
- **Full Stack & Web:** Node.js, React Native, Express, MongoDB
- **AI & Automation:** Google Gemini (Workflow Automation & Code Generation), LLM Prompting
- **Hardware & Fabrication:** ESP32/Microcontrollers, Arduino, PlatformIO, G-code generation
...
- **Brand:** [hayush.at](https://hayush.at)
